...
class LoginView: BaseView {
    ...
    let emailImage = {
        ...
        view.image = UIImage(named: UIImage.imageName.email.rawValue)
    ...
    let passwordImage = {
        let view = UIImageView()
        view.image = UIImage(named: UIImage.imageName.password.rawValue)
        view.contentMode = .scaleAspectFit
        return view
    }()
    ...
    override func setConstraints() {
        ...
        joinButton.snp.makeConstraints {
            ...
            $0.trailing.equalTo(loginButton.snp.trailing).inset(4)
